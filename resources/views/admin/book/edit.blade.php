...
@section('content')
    <form method="POST" action="{{ route('admin.book.update', $book->id) }}" class="space-y-8 px-8 md:px-32 py-4"
                    ...
                    <div class="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5">
                        ...
                        <div class="mt-1 sm:mt-0 sm:col-span-2">
                            <div class="max-w-lg flex rounded-md shadow-sm">
                                ...
                                <input id="name" name="name" type="text" autocomplete="name" required value="{{$book->name}}"
                    ...
                    <div class="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5">
                        ...
                        <div class="mt-1 sm:mt-0 sm:col-span-2">
                            <textarea id="description" name="description" rows="3" required
                                class="max-w-lg shadow-sm block w-full focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm border border-gray-300 rounded-md">{{ $book->description }}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5">
                        ...
                        <div class="flex text-sm text-gray-600">
                            <label for="image"
                                ...
                                <p class="mt-2 text-xs text-gray-500">Leave it empty if you don't want to change the book
                                    cover.</p>
                            </label>
                        </div>
                    </div>
